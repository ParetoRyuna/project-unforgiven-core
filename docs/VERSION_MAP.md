...
## Version Routing
- `v1` (ticketing app): `programs/unforgiven`
- `v2` (universal middleware): `programs/unforgiven_v2`
- `v2 SDK` (2-line integration target): `packages/universal-shield-sdk`
- `v2 Backend Services`: `services` (`shield-oracle` for 签名/防重放 + `dignity-scoring` for GitHub/Spotify/Twitter adapters)
- `v2 Demo`: `apps/kickstart-demo`
- `v2 Specs`: `docs/v2`
